...
ActiveRecord::Schema.define(:version => 20120913183245) do
  ...
  create_table "articles", :force => true do |t|
    t.date     "date"
    t.integer  "team_release_id"
    t.datetime "created_at",      :null => false
    t.datetime "updated_at",      :null => false
  end

  add_index "articles", ["team_release_id"], :name => "index_articles_on_team_release_id"
